        ...
        <div className="about">
          <div className="about_main flex gap-[24px] mb-[120px]">
            ...
            <div className="about_right pt-[40px] pb-[80px] pl-[66px] pr-[50px] bg-[#fff]  rounded-[6px]">
              <h1 className='text-[24px] font-medium text-[#000] mb-[17px]'>Способы оплаты
              </h1>
              <ul className='flex flex-col gap-[29px] '>
                <p className='text-[#000] text-[20px] leading-[22.4px] not-italic font-normal '>Для того, чтобы оплатить товар, Вам нужно перейти в «Корзину» и выбрать тот товар, который Вы хотите купить.
                </p>
                <p className='text-[#000] text-[20px] leading-[22.4px] not-italic font-normal '>После перехода в Корзину, откроется список товаров, которые Вы добавили. Далее, нажимаем кнопку «Оформить заказ».
                  В  окне, появится «Контактная информация» и «Способы доставки», которые Вам не обходимо заполнить. </p>
                <p className='text-[#000] text-[20px] leading-[22.4px] not-italic font-normal '>Вы можете выбрать более подходящий для Вас способ оплаты:
                  -Оплата на месте;
                  -Оплата по терминалу;
                  -Оплата через платёжные системы, такие как CLICK, Payme.
                </p>
                <p className='text-[#000] text-[20px] leading-[22.4px] not-italic font-normal '>платить покупки можно наличными при получении. Убедительная просьба вначале ознакомиться с товаром, убедиться в отсутствии дефектов в присутствии курьера, после чего оплачивать сумму.
                </p>
              </ul>
              <h1 className='text-[24px] font-medium text-[#000] mb-[17px] mt-[17px]'>Доставка
              </h1>
              <ul className='flex flex-col gap-[29px] '>
                <p className='text-[#000] text-[20px] leading-[22.4px] not-italic font-normal '>Тарифы на доставку товаров по Ташкенту:

                </p>
                <p className='text-[#000] text-[20px] leading-[22.4px] not-italic font-normal '>После перехода в Корзину, откроется список товаров, которые Вы добавили. Далее, нажимаем кнопку «Оформить заказ».
                  В  окне, появится «Контактная информация» и «Способы доставки», которые Вам не обходимо заполнить. </p>
                <p className='text-[#000] text-[20px] leading-[22.4px] not-italic font-normal '>
