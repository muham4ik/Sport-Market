    ...
    <footer className="bg-[#1F1D14] w-full border-t-[24px]  border-t-[#FBD029]">
      <div className="border-b-[1px] border-b-[#F2F2F2]">
        <div className="container">
          <nav className="navbar flex items-start pt-[77px] pb-[44px] justify-between">
            <Link href="#" className="flex items-center gap-[11px] mr-[72px]">
              <Image
                ...
                alt="logo"
              />
              <li className="flex flex-col items-start text-2xl not-italic font-semibold left-7 text-white">
                <p>Sport</p>
                <p>Market</p>
              </li>
            </Link>
            ...
            <Link href="#" className="flex items-center gap-[13px] mt-[23px]">
              <Image
                src={Icon}
              />
              <p className="text-[16px] not-italic font-normal leading-normal text-white">Tashkent Sh. Chilonzor 9 kvartal
                12 uy</p>
            </Link>
            <ul className="flex flex-col items-start gap-[20px] ml-[166px]">
              ...
              <ul className="flex items-center gap-[20px] mt-[49px]">
                <Link href="#"><Image src={Instagram} alt="footerimg"/></Link>
                <Link href="#"><Image src={Facebook} alt="footerimg"/></Link>
                <Link href="#"><Image src={Telegram} alt="footerimg"/></Link>
              </ul>
            </ul>
          </nav>
        </div>
      </div>
      <div className="container flex justify-between pt-[13px] pb-[22px]">
