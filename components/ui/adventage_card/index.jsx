    ...
    return (
        <div className="cards flex items-center gap-[24px]">
            {AdvImg.map((item, index) => (
                <div className="card flex flex-col items-start gap-[30px] bg-[#ffff] rounded-[8px]" key={index}>
                    ...
                    <div className="card_footer pb-[99px] pl-[40px] pr-[70px]">
                        <p className="text-[20px] not-italic font-normal leading-normal">{item.description}</p>
                    </div>
                </div>
            ))}
        </div>
