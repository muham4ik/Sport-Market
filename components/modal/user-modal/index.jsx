...
import Modal from '@mui/material/Modal'; // To'g'irlangan qator
import Fade from '@mui/material/Fade';
import { Button } from '@mui/material'; // To'g'irlangan qator
  ...
  return (
    <div className='container m-auto'>
      <Modal
        ...
        components={{ Backdrop: StyledBackdrop }} // To'g'irlangan qator
      >
        <Fade in={open}>
