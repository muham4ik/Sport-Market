    ...
    <>
      <div className="main mb-[80px]">
        <div className="container">
          <div className="about">
            <h1 className="text-[#1F1D14] text-[32px] not-italic font-medium leading-normal mb-[31px]">О нас</h1>
            <div className="about_bottom bg-[#1F1D14] flex flex-col gap-[15px] rounded-[8px] ">
              <p className="pt-[80px] pb-[15px] pl-[80px] pr-[259px] text-[20px] not-italic font-normal leading-[28px] text-[#fff]">
              ...
              <span className="flex  justify-end pr-[100px] pb-[50px]">
